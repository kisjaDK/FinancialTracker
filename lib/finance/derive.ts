...
export function getEffectiveSeat(
  ...
  return {
    ...
    team: applyOverrideValue(seat.team, override?.team),
    inSeat: applyOverrideValue(seat.inSeat, override?.inSeat),
    description: applyOverrideValue(seat.description, override?.description),
    band: applyOverrideValue(seat.band, override?.band),
    location: applyOverrideValue(seat.location, override?.location),
    vendor: applyOverrideValue(seat.vendor, override?.vendor),
    manager: applyOverrideValue(seat.manager, override?.manager),
    dailyRate: applyOverrideValue(seat.dailyRate, override?.dailyRate),
