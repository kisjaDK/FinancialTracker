...
if [ ! -f "$PRISMA_CLIENT_MARKER" ] || [ ! -f "$PRISMA_LINUX_ENGINE" ] || [ ! -f "$PRISMA_RUNTIME_CLIENT_MARKER" ] || [ ! -f "$PRISMA_RUNTIME_ENGINE" ] || [ ! -f "$PRISMA_RUNTIME_SCHEMA_MARKER" ] || [ prisma/schema.prisma -nt "$PRISMA_CLIENT_MARKER" ] || [ prisma/schema.prisma -nt "$PRISMA_RUNTIME_SCHEMA_MARKER" ] || [ package-lock.json -nt "$PRISMA_CLIENT_MARKER" ] || [ package-lock.json -nt "$PRISMA_RUNTIME_SCHEMA_MARKER" ]; then
